const CACHE_NAME = "community-news-prod-article-refresh-1";
const ASSETS = [
  "./",
  "./index.html?v=article-refresh-prod-1",
  "./styles.css?v=article-refresh-prod-1",
  "./app.js?v=article-refresh-prod-1",
