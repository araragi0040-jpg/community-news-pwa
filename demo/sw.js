const CACHE_NAME = "community-news-demo-scheduled-post-1";
const ASSETS = [
  "./",
  "./index.html?v=scheduled-post-demo-1",
  "./styles.css?v=scheduled-post-demo-1",
  "./app.js?v=scheduled-post-demo-1",
